...
async def extract_features(ctx: RequestContext, store: BaseStore) -> FeatureVector:
    ...
    # --- payload size z-score (approximate using a fixed light-weight model
    #     since we don't store raw payload history to stay low-latency;
    #     small requests ~200-800 bytes are "normal") ---
